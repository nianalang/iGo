        ...
        <div class="list_right" >
    		...
    		<ul class="list_right_ul2">
    			<div class="list_right_inf">
    				<h1 class="my_inf">我的信息</h1>
    				<img alt="" src="<%=basePath %>images/用户名.png" class="inf_img_user">
    				<p class="list_right_p">用户名：<span class="list_right_span">&nbsp;${users.userName }</span></p>
    				<img alt="" src="<%=basePath %>images/密码.png" class="inf_img_password">
    				<p class="list_right_p list_right_p2">密码：<span class="list_right_span">&nbsp;&nbsp;${users.password }</span></p>
    				<img alt="" src="<%=basePath %>images/电子邮件.png" class="inf_img_email">
    				<p class="list_right_p list_right_p3">电子邮箱：<span class="list_right_span">${users.email }</span></p>
    			</div>
    		</ul>
