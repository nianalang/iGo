        ...
        <div class="list_right" >
    		...
    		<ul class="list_right_ul3">	
    			<div class="list_inf_div">
    				<form action="UserServlet?action=updatemyinf" method="post" class="list_right_form">
    					<h1 class="list_inf">修改信息</h1>
    					<p class="list_inf_p list_inf_pa">用户名：&nbsp;<span class="list_right_span">${users.userName }</span></p>
    					<%-- <p class="list_inf_p list_inf_pa">用户名：&nbsp;${users.userName }<input type="text" name="inf_user" value="" class="list_inf_input" /></p> --%>
    					<p class="list_inf_p">新密码：&nbsp;<input type="text" name="inf_passwd"  class="list_inf_input" value="${users.password }"/></p>
    					<p class="list_inf_p">确认密码：<input type="text" name="inf_confirm"  class="list_inf_input" value="${users.password }"/></p>
    					<p class="list_inf_p">电子邮箱：<input type="text" name="inf_email"  class="list_inf_input" value="${users.email }"/></p>
